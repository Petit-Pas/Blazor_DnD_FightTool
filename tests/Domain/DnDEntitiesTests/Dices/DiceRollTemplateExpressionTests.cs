...
[TestFixture]
public class DiceRollTemplateExpressionTests
{
    [TestFixture]
    private class ParsingTests : DiceRollTemplateExpressionTests
    {
        [Test]
        public void Should_Parse_Dices_Properly()
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("3d12+1d8+3+MAS+2d4");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("STR+INT+DEX+1d6+3+MAS");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("STR+2+INT+DEX+1d6+3+MAS-1");
    ...
    [TestFixture]
    private class BuildExpressionTests : DiceRollTemplateExpressionTests
    {
        [Test]
        public void Should_Merge_Dices_With_Same_Value()
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("1d12+2d12-1d12");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("1d12+1d4-1d8");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("2+8");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("8+MAS+1d8");
        ...
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("1d8+1-1");
    ...
    [TestFixture]
    private class GetScoreModifierTests : DiceRollTemplateExpressionTests
    {
        [Test]
        public void Should_Include_Static_Modifiers()
        {
            // Arrange
            var diceThrow = new DiceRollTemplate("1d8+2");
        ...
        public void Should_Resolve_Wildcards()
        {
            ...
            var diceThrow = new DiceRollTemplate()
            {
                Expression = "1d8+MAS"
            };
