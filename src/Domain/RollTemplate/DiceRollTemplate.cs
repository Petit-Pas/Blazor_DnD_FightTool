...
namespace DnDFightTool.Domain.RollTemplate;
...
public partial class DiceRollTemplate : IHashable, IRegexValidated
{
    /// <summary>
    ///     Ctor for empty expression
    ///     As well as for serializer
    /// </summary>
    public DiceRollTemplate()
    {
    }
    ...
    public DiceRollTemplate(string expression)
    {
    ...
    /// </summary>
    internal readonly static Regex _regex = DiceRollTemplateRegex();
    ...
    private static partial Regex DiceRollTemplateRegex();
}
